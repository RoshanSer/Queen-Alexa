...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/RoshanSer/Queen-Alexa)
# ```ALEXA-BUG-BOT```
<p align="center">
...
[`Click Here`](session.json#L1)

## `SETTING`

- Owner number [Here](settings.json#L4)
- Owner Name [Here](settings.json#L14)
- Bot Name [Here](settings.json#L15)
